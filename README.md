...
O que esse kit faz
Analisa cada foto do seu HD: extrai data/hora (EXIF), detecta e agrupa rostos, gera "impressão digital" visual (embedding CLIP) e descrição em linguagem natural.
Descobre grupos automaticamente: agrupa fotos parecidas em clusters. Você revisa e nomeia os grupos (ex: "reuniões 2023", "evento cliente X", "fotos de produto").
Organiza em pastas: copia as fotos do HD externo pro SSD em pastas nomeadas.
App de busca: interface web local pra buscar por rosto, descrição, data, etc.
